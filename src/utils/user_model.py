class UserModel:
    ...
    # ask asaf about displaying like a tuple
    def display(self):
    ...
    def __str__(self):
        return f"(User ID: {self.userId}, First Name: {self.firstName}, Last Name: {self.lastName}, Email: {self.email}, Password: {self.password}, Role ID: {self.roleId})"
